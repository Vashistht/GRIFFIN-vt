...
def main(dataset='xsum', shots=1, model_arch='llama2', model_size=0, cache_dir=None, density=0.5,
         ...
         greedy=False, device='cuda:3', forward= True, select_every=None, wanda=True): # @vashisthtiwari 
    ...
    if wanda is False:
        ...
        config = AutoConfig.from_pretrained('/scratch/vash-experiment/wanda/sparsity-0.5')
        tokenizer = AutoTokenizer.from_pretrained('/scratch/vash-experiment/wanda/sparsity-0.5', use_fast=True)
        model = AutoModelForCausalLM.from_pretrained('/scratch/vash-experiment/wanda/sparsity-0.5')
