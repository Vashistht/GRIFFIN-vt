...
def main(dataset='xsum', shots=1, model_arch='llama2', model_size=0, cache_dir=None, density=0.5, selection_method='topk', sample_num=1, max_length=-1, k=0, max_tokens=64, seed=42, temp=0.3, greedy=False, device='cuda:1', forward= True, select_every=None): # @vashisthtiwari 
